...
class TestPasswordGroup(functional.BaseTestCase):
    ...
    def setUp(self):
        ...
        self.client.password_group.create(user_id=self.object_user_1,
                                          namespace=self.namespace_1,
                                          password=self.password_1,
                                          groups_list=self.groups_list_1)
    ...
    def test_password_group_create_for_user(self):
        response = self.client.password_group.create(user_id=self.object_user_1,
                                                     namespace=self.namespace_1,
                                                     password=self.password_1,
                                                     groups_list=self.groups_list_1)
    ...
    def test_password_group_delete_for_user(self):
        ...
        self.assertRaises(ECSClientException, f, self.groups_list_1)
